...
pushed-changes = Pushed changes to remote
...
selection-instructions = Use space to select/deselect, enter to confirm
...
# Help messages
save-local-help = Don't push changes to remote repository
